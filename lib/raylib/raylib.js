...
function findWasmBinary() {
  return locateFile('raylib_wasm.wasm');
}
...
var ASM_CONSTS = {
  24030: () => { if (document.fullscreenElement) return 1; },  
 24076: () => { return Module.canvas.width; },  
 24108: () => { return parseInt(Module.canvas.style.width); },  
 24156: () => { document.exitFullscreen(); },  
 24183: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 24255: () => { if (document.fullscreenElement) return 1; },  
 24301: () => { return Module.canvas.width; },  
 24333: () => { return screen.width; },  
 24358: () => { document.exitFullscreen(); },  
 24385: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 24579: () => { return window.innerWidth; },  
 24605: () => { return window.innerHeight; },  
 24632: () => { if (document.fullscreenElement) return 1; },  
 24678: () => { return Module.canvas.width; },  
 24710: () => { return parseInt(Module.canvas.style.width); },  
 24758: () => { if (document.fullscreenElement) return 1; },  
 24804: () => { return Module.canvas.width; },  
 24836: () => { return screen.width; },  
 24861: () => { return window.innerWidth; },  
 24887: () => { return window.innerHeight; },  
 24914: () => { if (document.fullscreenElement) return 1; },  
 24960: () => { return Module.canvas.width; },  
 24992: () => { return screen.width; },  
 25017: () => { document.exitFullscreen(); },  
 25044: () => { if (document.fullscreenElement) return 1; },  
 25090: () => { return Module.canvas.width; },  
 25122: () => { return parseInt(Module.canvas.style.width); },  
 25170: () => { document.exitFullscreen(); },  
 25197: ($0) => { Module.canvas.style.opacity = $0; },  
 25235: () => { return screen.width; },  
 25260: () => { return screen.height; },  
 25286: () => { return window.screenX; },  
 25313: () => { return window.screenY; },  
 25340: () => { return window.devicePixelRatio; },  
 25376: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 25429: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 25480: () => { Module.canvas.style.cursor = 'none'; },  
 25517: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 25773: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 25824: () => { if (document.pointerLockElement) return 1; },  
 25871: () => { if (document.fullscreenElement) return 1; },  
 25917: () => { return window.innerWidth; },  
 25943: () => { return window.innerHeight; }
};
...
var _rl_InitWindow = Module['_rl_InitWindow'] = makeInvalidEarlyAccess('_rl_InitWindow');
var _rl_CloseWindow = Module['_rl_CloseWindow'] = makeInvalidEarlyAccess('_rl_CloseWindow');
var _rl_WindowShouldClose = Module['_rl_WindowShouldClose'] = makeInvalidEarlyAccess('_rl_WindowShouldClose');
var _rl_BeginDrawing = Module['_rl_BeginDrawing'] = makeInvalidEarlyAccess('_rl_BeginDrawing');
var _rl_EndDrawing = Module['_rl_EndDrawing'] = makeInvalidEarlyAccess('_rl_EndDrawing');
var _rl_SetTargetFPS = Module['_rl_SetTargetFPS'] = makeInvalidEarlyAccess('_rl_SetTargetFPS');
var _rl_IsKeyPressed = Module['_rl_IsKeyPressed'] = makeInvalidEarlyAccess('_rl_IsKeyPressed');
var _rl_IsGamepadButtonPressed = Module['_rl_IsGamepadButtonPressed'] = makeInvalidEarlyAccess('_rl_IsGamepadButtonPressed');
var _rl_GetFrameTime = Module['_rl_GetFrameTime'] = makeInvalidEarlyAccess('_rl_GetFrameTime');
var _rl_CheckCollisionRecs = Module['_rl_CheckCollisionRecs'] = makeInvalidEarlyAccess('_rl_CheckCollisionRecs');
var _rl_ClearBackground = Module['_rl_ClearBackground'] = makeInvalidEarlyAccess('_rl_ClearBackground');
var _rl_DrawRectangle = Module['_rl_DrawRectangle'] = makeInvalidEarlyAccess('_rl_DrawRectangle');
var _rl_DrawText = Module['_rl_DrawText'] = makeInvalidEarlyAccess('_rl_DrawText');
...
function assignWasmExports(wasmExports) {
  assert(typeof wasmExports['rl_InitWindow'] != 'undefined', 'missing Wasm export: rl_InitWindow');
  assert(typeof wasmExports['rl_CloseWindow'] != 'undefined', 'missing Wasm export: rl_CloseWindow');
  assert(typeof wasmExports['rl_WindowShouldClose'] != 'undefined', 'missing Wasm export: rl_WindowShouldClose');
  assert(typeof wasmExports['rl_BeginDrawing'] != 'undefined', 'missing Wasm export: rl_BeginDrawing');
  assert(typeof wasmExports['rl_EndDrawing'] != 'undefined', 'missing Wasm export: rl_EndDrawing');
  assert(typeof wasmExports['rl_SetTargetFPS'] != 'undefined', 'missing Wasm export: rl_SetTargetFPS');
  assert(typeof wasmExports['rl_IsKeyPressed'] != 'undefined', 'missing Wasm export: rl_IsKeyPressed');
  assert(typeof wasmExports['rl_IsGamepadButtonPressed'] != 'undefined', 'missing Wasm export: rl_IsGamepadButtonPressed');
  assert(typeof wasmExports['rl_GetFrameTime'] != 'undefined', 'missing Wasm export: rl_GetFrameTime');
  assert(typeof wasmExports['rl_CheckCollisionRecs'] != 'undefined', 'missing Wasm export: rl_CheckCollisionRecs');
  assert(typeof wasmExports['rl_ClearBackground'] != 'undefined', 'missing Wasm export: rl_ClearBackground');
  assert(typeof wasmExports['rl_DrawRectangle'] != 'undefined', 'missing Wasm export: rl_DrawRectangle');
  assert(typeof wasmExports['rl_DrawText'] != 'undefined', 'missing Wasm export: rl_DrawText');
  ...
  _rl_InitWindow = Module['_rl_InitWindow'] = createExportWrapper('rl_InitWindow', 3);
  _rl_CloseWindow = Module['_rl_CloseWindow'] = createExportWrapper('rl_CloseWindow', 0);
  _rl_WindowShouldClose = Module['_rl_WindowShouldClose'] = createExportWrapper('rl_WindowShouldClose', 0);
  _rl_BeginDrawing = Module['_rl_BeginDrawing'] = createExportWrapper('rl_BeginDrawing', 0);
  _rl_EndDrawing = Module['_rl_EndDrawing'] = createExportWrapper('rl_EndDrawing', 0);
  _rl_SetTargetFPS = Module['_rl_SetTargetFPS'] = createExportWrapper('rl_SetTargetFPS', 1);
  _rl_IsKeyPressed = Module['_rl_IsKeyPressed'] = createExportWrapper('rl_IsKeyPressed', 1);
  _rl_IsGamepadButtonPressed = Module['_rl_IsGamepadButtonPressed'] = createExportWrapper('rl_IsGamepadButtonPressed', 2);
  _rl_GetFrameTime = Module['_rl_GetFrameTime'] = createExportWrapper('rl_GetFrameTime', 0);
  _rl_CheckCollisionRecs = Module['_rl_CheckCollisionRecs'] = createExportWrapper('rl_CheckCollisionRecs', 2);
  _rl_ClearBackground = Module['_rl_ClearBackground'] = createExportWrapper('rl_ClearBackground', 1);
  _rl_DrawRectangle = Module['_rl_DrawRectangle'] = createExportWrapper('rl_DrawRectangle', 5);
  _rl_DrawText = Module['_rl_DrawText'] = createExportWrapper('rl_DrawText', 5);
...
if (typeof exports === 'object' && typeof module === 'object') {
  module.exports = createRaylib;
  // This default export looks redundant, but it allows TS to import this
  // commonjs style module.
  module.exports.default = createRaylib;
